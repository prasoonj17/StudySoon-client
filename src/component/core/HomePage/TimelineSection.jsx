    ...
    return (
        <div>
            <div className='flex flex-col lg:flex-row gap-20 mb-20 items-center'>
                ...
                <div className='relative w-fit h-fit shadow-green-300 shadow-[0px_0px_30px_0px]'>
            ...
            lg:translate-y-[50%] bg-green-900 top-0 lg:top-auto
            flex lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10 '>
                        <div className='flex gap-5 items-center lg:border-r border-green-300 px-7 lg:px-14'>
                            ...
                            <p className='text-green-300 text-sm w-[75px]'>Years of Experience</p>
                        </div>
